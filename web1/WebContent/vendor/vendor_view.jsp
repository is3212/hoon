...
<tr>
<td>
<button id="btnUpdate" class="btn btn-md-2 btn-block btn-primary" type="button">수정</button>
</td>
<td>
<button id="btnDelete" class="btn btn-md-2 btn-block btn-primary" type="button">삭제</button>
</td>
<td>
<button id="btnGoList" class="btn btn-md-2 btn-block btn-primary"  type="button">리스트 이동</button>
</td>
</tr>
</thead>
</table>
